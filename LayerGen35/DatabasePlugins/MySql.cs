        ...
        private void CreateCsBusinessLayers()
        {
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\" + objName.ToProperFileName() + "Business.cs"))
                {
                    ...
                    var fkBusinessGetByConn = new StringBuilder();
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\" + objName.ToProperFileName() + "Data.cs"))
                {
                    ...
                    foreach (Field field in fields)
                    {
                        ...
                        {
                            if (field.IntrinsicSqlDataType.ToLower() == "tinyint(1)")
                            {
                                fillPart.Append("                    " + field.SafeCsPropertyName +
                                                " = Convert.ToBoolean((" +
                                                "bool) dr[_internalNameDictionary[" + BusinessNamespaceName +
                                                "." + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) +
                                                ".Fields." +
                                                field.SafeCsPropertyName + "]]);" + Environment.NewLine);
                            }
                            else
                    ...
                    foreach (Field field in fields.Where(z => (!z.IsIdentity) && (!z.IsComputedField)).OrderBy(z => z.FieldName))
                    {
                        savePart.AppendLine("                        parameter = new MySqlParameter(\"@val" + i + "\", MySqlDbType." + field.SqlDbType + ");");
                    ...
                    var fkDataGetByConn = new StringBuilder();
                    ...
                    if (!isView)
                    {
                        ...
                        foreach (ForeignKey key in keys)
                        {
                            ...
                            fkDataGetBy.Append("            using (MySqlConnection connection = new MySqlConnection(Universal.GetConnectionString()))" + Environment.NewLine);
                            fkDataGetBy.Append("            {" + Environment.NewLine);
                            fkDataGetBy.Append("                using (MySqlCommand command = new MySqlCommand())" + Environment.NewLine);
                            fkDataGetBy.Append("                {" + Environment.NewLine);
                            ...
                            fkDataGetBy.AppendLine("                    MySqlParameter parameter =  new MySqlParameter(\"@val1\", MySqlDbType." + sqlDataType + ");");
                            ...
                            fkDataGetBy.Append("                    using (MySqlDataAdapter adapter = new MySqlDataAdapter())" + Environment.NewLine);
                            fkDataGetBy.Append("                    {" + Environment.NewLine);
                            ...
                            fkDataGetByConn.Append("        internal static DataTable GetBy" + Common.GetSafeCsName(Common.GetCsPropertyName(key.ForeignColumnName)) + "(" + BusinessNamespaceName + ".LayerGenConnectionString connectionString, ");
                            foreach (Field f in fields)
                            {
                                if (String.Equals(f.FieldName, key.ForeignColumnName, StringComparison.CurrentCultureIgnoreCase))
                                {
                                    sqlDataType = f.SqlDbType;
                                    fkDataGetByConn.Append(f.CsDataType + " fkId)" + Environment.NewLine);
                                    break;
                                }
                            }
                            fkDataGetByConn.Append("        {" + Environment.NewLine);
                            fkDataGetByConn.Append("            using (MySqlConnection connection = new MySqlConnection(connectionString.ConnectionString))" + Environment.NewLine);
                            fkDataGetByConn.Append("            {" + Environment.NewLine);
                            fkDataGetByConn.Append("                using (MySqlCommand command = new MySqlCommand())" + Environment.NewLine);
                            fkDataGetByConn.Append("                {" + Environment.NewLine);
                            fkDataGetByConn.Append("                    command.Connection = connection;" + Environment.NewLine);
                            fkDataGetByConn.Append("                    command.CommandType = CommandType.Text;" + Environment.NewLine);
                            fkDataGetByConn.Append("                    command.CommandText = \"SELECT * FROM `" + key.ForeignTableName + "` WHERE `" + key.ForeignColumnName + "`=@val1\";" + Environment.NewLine);
                            fkDataGetByConn.AppendLine("                    MySqlParameter parameter =  new MySqlParameter(\"@val1\", MySqlDbType." + sqlDataType + ");");
                            fkDataGetByConn.AppendLine("                    parameter.Value = fkId;");
                            fkDataGetByConn.AppendLine("                    command.Parameters.Add(parameter);");
                            //fkDataGetByConn.Append("                    command.Parameters.Add(new MySqlParameter(\"@val1\", MySqlDbType." + sqlDataType + ") {Value = fkId});" + Environment.NewLine);
                            fkDataGetByConn.Append(Environment.NewLine);
                            fkDataGetByConn.Append("                    connection.Open();" + Environment.NewLine);
                            fkDataGetByConn.Append("                    using (MySqlDataAdapter adapter = new MySqlDataAdapter())" + Environment.NewLine);
                            fkDataGetByConn.Append("                    {" + Environment.NewLine);
                            fkDataGetByConn.Append("                        using (DataSet ds = new DataSet())" + Environment.NewLine);
                            fkDataGetByConn.Append("                        {" + Environment.NewLine);
                            fkDataGetByConn.Append("                            adapter.SelectCommand = command;" + Environment.NewLine);
                            fkDataGetByConn.Append("                            adapter.Fill(ds);" + Environment.NewLine);
                            fkDataGetByConn.Append(Environment.NewLine);
                            fkDataGetByConn.Append("                            if (ds.Tables.Count > 0)" + Environment.NewLine);
                            fkDataGetByConn.Append("                            {" + Environment.NewLine);
                            fkDataGetByConn.Append("                                return ds.Tables[0];" + Environment.NewLine);
                            fkDataGetByConn.Append("                            }" + Environment.NewLine);
                            fkDataGetByConn.Append("                        }" + Environment.NewLine);
                            fkDataGetByConn.Append("                    }" + Environment.NewLine);
                            fkDataGetByConn.Append("                }" + Environment.NewLine);
                            fkDataGetByConn.Append("            }" + Environment.NewLine);
                            fkDataGetByConn.Append(Environment.NewLine);
                            fkDataGetByConn.Append("            return null;" + Environment.NewLine);
                            fkDataGetByConn.Append("        }" + Environment.NewLine);
                        }
                    ...
                    dataLayerTemplate.Replace("{23}", fkDataGetBy + Environment.NewLine + fkDataGetByConn);
                    if (isView)
                    {
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\" + objName.ToProperFileName() + "Data.vb"))
                {
                    ...
                    foreach (Field field in fields)
                    {
                        ...
                        } else if (field.CsDataType.ToLower() == "bool")
                        {
                            ...
                            {
                                fillPart.Append("                    " + field.SafeVbPropertyName +
                                                " = Convert.ToBoolean(DirectCast(dr(_internalNameDictionary(" +
                                                BusinessNamespaceName + "." +
                                                Common.GetSafeVbName(Common.GetVbPropertyName(objName)) + ".Fields." +
                                                field.SafeVbPropertyName + ")), Boolean))" + Environment.NewLine);
                            }
                            else
                            {
                                fillPart.Append("                    " + field.SafeVbPropertyName +
                    ...
                    foreach (Field field in fields.OrderByDescending(z => z.IsPrimaryKey))
                    {
                        ...
                        else
                        {
                            ...
                            else if (field.CsDataType.ToLower() == "bool")
                            {
                                ...
                                {
                                    getPart.Append("                                " + field.SafeVbPropertyName +
                                                   " = Convert.ToBoolean(DirectCast(reader(\"" + field.FieldName +
                                                   "\"), Boolean" +
                                                   "))" + Environment.NewLine);
                                }
                                else
                    ...
                    if (!isView)
                    {
                        ...
                        foreach (ForeignKey key in keys)
                        {
                            ...
                            fkDataGetBy.Append("                    command.CommandType = CommandType.Text" + Environment.NewLine);
                            fkDataGetBy.Append("                    command.CommandText = \"SELECT * FROM `" + key.ForeignTableName + "` WHERE `" + key.ForeignColumnName + "`=@val1\"" + Environment.NewLine);
                            fkDataGetBy.AppendLine("                    Dim parameter As New MySqlParameter(\"@val1\", MySqlDbType." + sqlDataType + ")");
                            fkDataGetBy.AppendLine("                    parameter.Value = fkId");
                            fkDataGetBy.AppendLine("                    command.Parameters.Add(parameter)");
                            ...
                            fkDataGetByConnString.Append("            Using connection As New MySqlConnection(connString.ConnectionString)" + Environment.NewLine);
                            fkDataGetByConnString.Append("                Using command As New MySqlCommand()" + Environment.NewLine);
                            ...
                            fkDataGetByConnString.AppendLine("                    Dim parameter As New MySqlParameter(\"@val1\", MySqlDbType." + sqlDataType + ")");
                            fkDataGetByConnString.AppendLine("                    parameter.Value = fkId");
                            fkDataGetByConnString.AppendLine("                    command.Parameters.Add(parameter)");
                            //fkDataGetByConnString.Append("                    command.Parameters.Add(New MySqlParameter(\"@val1\", MySqlDbType." + sqlDataType + ") With { _" + Environment.NewLine);
                            ...
                            fkDataGetByConnString.Append("                    Using adapter As New MySqlDataAdapter()" + Environment.NewLine);
                    ...
                    dataLayerTemplate = dataLayerTemplate.Replace("{23}", fkDataGetBy + Environment.NewLine + fkDataGetByConnString);
       ...
       private List<Field> MapFields(string tableName)
        ...
        private List<ForeignKey> GetForeignKeys(string tableName)
        {
            ...
            using (var connection = new MySqlConnection(ConnectionString))
            {
                ...
                sql = sql + " AND k.CONSTRAINT_SCHEMA = '" + DatabaseName + "';";
